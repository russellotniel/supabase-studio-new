    ...
    return (
      <>
        <Head>
          <title>
            {title
              ? `${title} | Kalbe Software Factory API`
              : selectedTable
                ? `${selectedTable} | ${projectName} | ${organizationName} | Kalbe Software Factory API`
                : projectName
                  ? `${projectName} | ${organizationName} | Kalbe Software Factory API`
                  : organizationName
                    ? `${organizationName} | Kalbe Software Factory API`
                    : 'Kalbe Software Factory API'}
          </title>
          <meta name="description" content="Kalbe Software Factory API Studio" />
        </Head>
