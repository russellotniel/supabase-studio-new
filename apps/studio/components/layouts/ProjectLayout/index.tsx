    ...
    return (
      <>
        <Head>
          <title>
            {title
              ? `${title} | Kalbe DevStreams-API`
              : selectedTable
                ? `${selectedTable} | ${projectName} | ${organizationName} | Kalbe DevStreams-API`
                : projectName
                  ? `${projectName} | ${organizationName} | Kalbe DevStreams-API`
                  : organizationName
                    ? `${organizationName} | Kalbe DevStreams-API`
                    : 'Kalbe DevStreams-API'}
          </title>
          <meta name="description" content="Kalbe DevStreams-API Studio" />
        </Head>
